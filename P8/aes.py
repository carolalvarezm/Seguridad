...
#x = np.array([["2b", "28", "ab", "09"], ["7e", "ae", "f7", "cf"],["15", "d2", "15", "4f"],["16", "a6", "88", "3c"]])
#y = np.array([["00", "01", "02", "03"], ["04", "05", "06", "07"],["08", "09", "0a", "0b"],["0c", "0d", "0e", "0f"]])
#z = np.array([["19", "a0", "9a", "e9"], ["3d", "f4", "c6", "f8"],["e3", "e2", "8d", "48"],["be", "2b", "2a", "08"]])
